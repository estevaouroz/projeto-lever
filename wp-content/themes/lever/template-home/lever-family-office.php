    ...
    <section class="hero-content" id="home">
        ...
        <div class="scroll-indicator">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 5V19M12 19L19 12M12 19L5 12" stroke="#070932" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
    </section>
</div>
    ...
    <div class="container-foco">
        ...
        <div class="content-direita">
            <div class="image-wrapper" data-aos="fade-up" data-aos-duration="2000">
                ...
                if ($image) : ?>
                    <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" class="img-principal">
                <?php endif; ?>
...
<section class="valores" id="sobre">
    <div class="bg-valores">
        ...
        if ($image) : ?>
            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" class="img-bottom">
        <?php endif; ?>
    </div>
                ...
                <div class="processo-coluna" data-aos="fade-up" data-aos-delay="<?php echo $delay; ?>">
                    ...
                    <div class="processo-itens">
                        ...
                        if (have_rows('processo_item_repetidor')) :
                            while (have_rows('processo_item_repetidor')) : the_row(); 
...
<section class="footer" id="contato" style="background-image: url('<?php echo esc_url($bg_url); ?>');">
    <div class="footer-container">
        ...
        <div class="footer-quote-wrapper">
            ...
            <div class="footer-contact-info">
                ...
                <div class="footer-repetidor">
                    <?php if (have_rows('footer_repetidor')) :
                        while (have_rows('footer_repetidor')) : the_row(); ?>
            ...
            <div class="rodape">
                <h6><?php echo get_field('footer_marca'); ?></h6>
